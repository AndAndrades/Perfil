...
export default function Footer() {
  ...
  return (
    <footer id="contacto" className="relative border-t border-white/10 bg-[#090d16] pt-20 pb-12 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        {/* Contact CTA Card */}
        <div className="rounded-3xl border border-indigo-500/20 bg-gradient-to-b from-[#0f172a]/90 to-[#090d16] p-8 sm:p-12 mb-16 shadow-2xl backdrop-blur-xl flex flex-col md:flex-row items-center justify-between gap-8">
          <div className="space-y-3 text-center md:text-left max-w-xl">
            ...
            <p className="text-slate-400 text-sm sm:text-base leading-relaxed">
              Hablemos sobre arquitectura de software, optimización de sistemas o nuevos proyectos fullstack.
            </p>
          </div>
          ...
          <div className="flex flex-col sm:flex-row items-center gap-3 w-full md:w-auto">
            ...
            <a
              href={`mailto:${email}`}
              className="flex items-center justify-center gap-2 px-6 py-3.5 rounded-2xl bg-indigo-600 hover:bg-indigo-500 text-white text-sm font-semibold shadow-lg shadow-indigo-600/30 transition-all duration-300 w-full sm:w-auto hover:scale-105"
            >
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
          ...
          <div className="space-y-3">
            <h5 className="text-xs font-bold uppercase tracking-wider text-slate-300">Navegación</h5>
          ...
          {/* Social Links */}
          <div className="space-y-3">
            <h5 className="text-xs font-bold uppercase tracking-wider text-slate-300">Conexiones</h5>
            <div className="flex items-center gap-3">
              <a
                href="https://www.linkedin.com/in/andandrades/"
                target="_blank"
                rel="noreferrer"
                className="p-3 rounded-xl bg-white/5 border border-white/10 hover:border-indigo-500/40 hover:bg-white/10 text-slate-300 hover:text-white transition-all duration-200 hover:scale-105"
                title="LinkedIn"
              >
        ...
        <div className="pt-8 border-t border-white/5 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-slate-500">
          <p>© {new Date().getFullYear()} Andrew Andrades. Diseñado y construido con React 19, Tailwind CSS v4 & Shaders.</p>
          <button
            onClick={scrollToTop}
